...
namespace Assets._Project.Develop.Runtime.Gameplay.EntitiesCore
{
    public class CollidersRegistryService
    {
        ...
        public void Register(Collider collider, Entity entity) => _colliderToEntity.Add(collider, entity);

        public void Unregister(Collider collider) => _colliderToEntity.Remove(collider);
